...
public class InMemoryNotificationRepositoryImpl implements NotificationRepository {
    ...
    // Custom methods from NotificationRepository interface
    @Override
    ...
    public void delete(Notification entity) {
        if (entity != null) {
            notificationStore.remove(entity.getId());
        }
    }
    ...
    public Notification getById(Long id) {
         return findById(id).orElseThrow(() -> new EntityNotFoundException("Unable to find Notification with id " + id));
    }
